...
class ControllerPertandingan extends CI_Controller
{
  ...
  public function edit_pertandingan_form($id_pertandingan)
  {
    ...
    // dd($statistik);
    $musim = $this->db->get("musim")->result();
    $data = [
  ...
  public function update_pertandingan_action($id_pertandingan)
  {
    ...
    $this->PertandinganModel->update_pertandingan($id_pertandingan, $data);
