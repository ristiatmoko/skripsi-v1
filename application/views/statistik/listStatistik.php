                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($statistiks as $statistik) : ?>
                                        <tr>
                                            ...
                                            <td><?=
                                                anchor(
                                                    site_url('ControllerStatistik/update_statistik/' . $statistik->id_statistik),
                                                    '<i class="fas fa-edit"></i> Edit',
                                                    'class="btn btn-danger" title="Edit Data"'
                                                ) . " "
                                                    . anchor(
                                                        site_url('ControllerStatistik/hapus_musim_action/' . $statistik->id_statistik),
                                                        '<i class="fa fa-archive"></i> Hapus',
                                                        'data-nama="' . $statistik->id_statistik . '" class="btn btn-primary hapus" title="Hapus Data"'
                                                    ) ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
