                        ...
                        <form class="form-material form-horizontal" method="POST" action="<?= base_url('controllerKriteria/edit_kriteria_action/'.$kriteria->id_kriteria) ?>" 
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="bobot_kepentingan" name="bobot_kepentingan" class="form-control" value="<?= $kriteria->bobot_kepentingan ?>"  placeholder="Ketikkan Bobot Kepentingan" required>
